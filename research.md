...
<img align="right" width="300 px" src="assets/images/2Guppys_model_SQIL.gif">             
...
<b>Figure:</b>A neural network was trained to imitate tracking data of pairs of female Guppys. The gif shows a simulation of two (identical) networks interacting in a virtual tank. Video created by Marc Gröhling.
...
<img width="80%" src="assets/images/follow_me.png">  
<b>Figure:</b> We have built robotic guppys that can interact with live fish in real-time. In one of our works we studied which adaptive strategies fish may employ to optimize their leadership performance when interaction partners may exhibit an (unknown) personality profile.
